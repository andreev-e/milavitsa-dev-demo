export default {
  route: {
    ...
    tinymce: 'Tinymce',
    buildingsList: 'Список',
    land_plotsList: 'Список',
    land_plotCreate: 'Создать',
    buildingCreate: 'Создать',
    buildingUpdate: 'Список на обновление',
    buildingEdit: 'Редактирование здания',
    land_plotEdit: 'Редактирование земельного участка',
    markdown: 'Markdown',
